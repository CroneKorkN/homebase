...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { date: @measurement.date, sensor_id: @measurement.sensor_id, value: @measurement.value } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { date: @measurement.date, sensor_id: @measurement.sensor_id, value: @measurement.value } }
