...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { identifier: @sensor.identifier, name: @sensor.name, type: @sensor.type } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { identifier: @sensor.identifier, name: @sensor.name, type: @sensor.type } }
